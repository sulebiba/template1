  ...
  <div class="container">
    <div class="row">
       ...
       <div class="col-md-offset-1 col-md-10 col-sm-12">
        ...
        <form action="form.php" method="post" class="wow fadeInUp" data-wow-delay="0.8s"onsubmit='return validate()'>
          <div class="col-md-6 col-sm-6">
            <input name="name" type="text" class="form-control" id="name" placeholder="First Name" required>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				...
				<p class="wow fadeInUp"  data-wow-delay="1s" >Copyright &copy; 2021 
